        ...
        <div className="space-y-8 divide-y divide-gray-200">
          <div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              {props.editEntries.map(
                (editEntry: EditEntry, index): React.ReactNode => {
                  const requiredMark = editEntry.isRequired ? "*" : "";
                  if (editEntry.condition !== null) {
                    if (!editEntry.condition) <></>;
                  }
                  if (
                    !editEntry.type ||
                    editEntry.type === EditEntryType.Text
                  ) {
                    return (
                                    ...
                                    <input
                                      ...
                                      onChange={(event) => {
                                        if (
                                          ...
                                          return;
                                        if (
                                          event.target.files[0].size > 10090000
                                        ) {
                                          toast.error(
                                            "Please upload file under 10MB."
                                          );
                                          return;
                                        }
                                        uploadFileToFirestore(
                      ...
                      <div className="col-span-6">
                          ...
                          <textarea
                            ...
                            defaultValue={
                              ...
                              entity[editEntry.attribute]["content"]
                                ? typeof entity[editEntry.attribute][
                                    "content"
                                  ] === "string"
                                  ? entity[editEntry.attribute]["content"]
                        ...
                        <div className="my-2 flex items-center">
                          <span className="h-20 aspect-video overflow-hidden bg-gray-300">
                            {uploadPhotoMap[
                              editEntry.attribute + "_image_url"
                            ] ? (
                              <img
                                src={
                                  uploadPhotoMap[
                              ...
                              >
                                <option
                                  selected={
                                    entity &&
                                    entity[editEntry.attribute] &&
                                    entity[editEntry.attribute]["country"] ===
                                      "United States"
                                  }
                                >
                                  United States
                    ...
                    return (
                      <div className="col-span-6" key={editEntry.attribute}>
                          ...
                          <>
                            ...
                            <div className="col-span-6 py-3">
                              ...
                              <div className="my-2 flex items-center">
                                <span className="h-12 w-12 overflow-hidden rounded-full bg-gray-300">
                                  {uploadPhotoMap[
                                    editEntry.attribute + "_profile_photo_url"
                                  ] ? (
                                    <img
                                      className="object-cover aspect-square"
                                      src={
                        ...
                        <FileUpload
                          ...
                          fieldDisplaySubName={`Select up to 6 images to showcase${
                            isInstagramShowcase ? " your Instagram" : ""
                          }.`}
